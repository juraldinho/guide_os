...
REQUIRED_VARIABLES = {
    ...
    "GUIDE_OS_SERVICE_AUTH_ENABLED",
    "GUIDE_OS_GUIDE_OPERATOR_JWT_PUBLIC_KEYS",
    "GUIDE_OS_SIGNING_KID",
    "GUIDE_OS_SIGNING_PRIVATE_KEY_PEM",
    "GUIDE_OS_GUIDE_OPERATOR_INTEGRATION_ENABLED",
    "GUIDE_OS_GUIDE_OPERATOR_INTEGRATION_HOST",
    "GUIDE_OS_GUIDE_OPERATOR_INTEGRATION_PORT",
    "GUIDE_OS_GUIDE_OPERATOR_OUTBOUND_ENABLED",
    "GUIDE_OS_GUIDE_OPERATOR_BASE_URL",
    "GUIDE_OS_GUIDE_OPERATOR_OUTBOUND_WORKER_ENABLED",
    "GUIDE_OS_GUIDE_OPERATOR_OUTBOUND_WORKER_ONCE",
    "GUIDE_OS_GUIDE_OPERATOR_OUTBOUND_WORKER_POLL_INTERVAL_SECONDS",
    "GUIDE_OS_GUIDE_OPERATOR_OUTBOUND_WORKER_BATCH_SIZE",
    "GUIDE_OS_GUIDE_OPERATOR_NOTIFICATION_DELIVERY_ENABLED",
    ...
    "MINI_APP_API_HOST",
    "MINI_APP_API_PORT",
    "MINI_APP_API_DEV_AUTH",
    "MINI_APP_SESSION_TTL_SECONDS",
    "MINI_APP_INITDATA_MAX_AGE",
    "MINI_APP_API_ALLOWLIST",
}
...
def test_reproducible_environment_documentation_is_complete_and_safe():
    ...
    assert values["GUIDESHOP_STAGING_LIFECYCLE_JWT_PUBLIC_KEYS"] == "{}"
    assert values["GUIDESHOP_PRODUCTION_LIFECYCLE_JWT_PUBLIC_KEYS"] == "{}"
    assert values["GUIDE_OS_GUIDE_OPERATOR_JWT_PUBLIC_KEYS"] == "{}"
    assert values["GUIDE_OS_SIGNING_KID"] == ""
    assert values["GUIDE_OS_SIGNING_PRIVATE_KEY_PEM"] == ""
    assert values["GUIDE_OS_GUIDE_OPERATOR_INTEGRATION_HOST"] == "127.0.0.1"
    assert values["GUIDE_OS_GUIDE_OPERATOR_INTEGRATION_PORT"] == "8084"
    assert values["GUIDE_OS_GUIDE_OPERATOR_BASE_URL"] == ""
    assert values["GUIDE_OS_GUIDE_OPERATOR_OUTBOUND_WORKER_POLL_INTERVAL_SECONDS"] == "5"
    assert values["GUIDE_OS_GUIDE_OPERATOR_OUTBOUND_WORKER_BATCH_SIZE"] == "10"
    assert (
        values["GUIDE_OS_GUIDE_OPERATOR_NOTIFICATION_WORKER_POLL_INTERVAL_SECONDS"]
        == "5"
    )
    assert values["GUIDE_OS_GUIDE_OPERATOR_NOTIFICATION_WORKER_BATCH_SIZE"] == "10"
    assert (
        values["GUIDE_OS_GUIDE_OPERATOR_NOTIFICATION_WORKER_SHUTDOWN_TIMEOUT_SECONDS"]
        == "15"
    )
