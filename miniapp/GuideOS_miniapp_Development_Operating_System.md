...
- загружается вертикальная лента, начинающаяся с сегодняшнего дня и продолжающаяся вперёд с постепенной догрузкой;
...
- слева — официальный логотип Guide OS; нажатие возвращает ленту к сегодняшнему дню;
- строго по центру — нажимаемый месяц и год верхней видимой даты ленты;
- справа — шестерёнка настроек;
- отдельная кнопка `Сегодня` отсутствует.

Шапка закреплена. При прокрутке через границу месяца или года центральный заголовок обновляется автоматически: `Август 2026`, `Сентябрь 2026`, …, `Январь 2027`.

### 8.2 Основная лента и календарь месяца

По умолчанию лента начинается с сегодняшнего дня. При приближении к её концу следующие даты догружаются порциями, поэтому гид может непрерывно прокручивать будущие месяцы и годы. Искусственного лимита в восемь дней нет.
