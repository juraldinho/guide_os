...
async def cmd_start(message: Message) -> None:
    ...
    text = (
        ...
        "📋 открывать карточки туров смотреть и редактировать данные\n"
        "📊 анализировать статистику по загруженным дням и доходу\n\n"
        ...
        "Для дополнительной информации нажмите /help"
    )
